...
<template>
  <div class="item">
    ...
    <span>{{ item.name }}</span>
    <input type="number" v-model.number="item.quantity" @change="updateQuantity" />
    <input type="color" :value="item.color" @change="updateColor" />
  </div>
</template>
...
.item input[type="number"], .item input[type="color"] {
